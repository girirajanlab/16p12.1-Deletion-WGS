...
GENE_LIST_DIR="/path/to/proband/gene/list/directory" # Use the output directory of script 3_Data preparation\SSC\4_make_genelists.py
...
GO_OUTPUT="/path/to/output/GO/KEGG/enrichments.csv" # Data presented in Table S6C
GMT_OUTPUT_DIR="/path/to/GMT/output/directory/" # A directory for GMT files for use in EnrichmentMap in Cytoscape. These files are used to create Fig 7C
...
# Make a plot of GO terms in Cytoscape using the GMT files