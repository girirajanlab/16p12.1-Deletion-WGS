...
# Perform t-tests for the burden of specific variant classes between DD cohort children with and without specific phenotypes
...
OUTPUT_HEATMAP="/path/to/output/heatmap/figure.pdf" # Heatmap presented in Fig 6F left
