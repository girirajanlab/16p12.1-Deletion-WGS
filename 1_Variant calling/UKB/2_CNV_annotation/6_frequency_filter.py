...
# Get the number of UKB participants who passed QC
...
dels = pd.read_csv(f'{input_path}/intracohort_anno_dels.bed', sep = '\t',
					names = ['Chr', 'Start', 'End', 'Type', 'Zygosity', 'Length', 'NumSNP', 'Sample', 'StartSNP', 'EndSNP', 'Merge', 'Control_num', 'UKB_num'])
dels['Control_freq'] = dels.Control_num / ncontrol
dels['UKB_freq'] = dels.UKB_num / pass_num
...
dups['UKB_freq'] = dups.UKB_num / pass_num
...
patho_del = pd.read_csv(f'{input_path}/pathogenic_anno_dels.bed', sep = '\t',
	names = ['Chr', 'Start', 'End', 'Type', 'Zygosity', 'Length', 'NumSNP', 'Sample', 'StartSNP', 'EndSNP', 'Merge', 'Control_num', 'UKB_num', 'Patho_chr', 'Patho_Start', 'Patho_End', 'Patho_Name'])
patho_del['Control_freq'] = patho_del.Control_num / ncontrol
patho_del['UKB_freq'] = patho_del.UKB_num / pass_num
...
patho_dup['UKB_freq'] = patho_dup.UKB_num / pass_num
...
del_calls = dels.merge(patho_del, how = 'outer',
	on = ['Chr', 'Start', 'End', 'Type', 'Zygosity', 'Length', 'NumSNP', 'Sample', 'StartSNP', 'EndSNP', 'Merge', 'Control_num', 'Control_freq', 'UKB_num', 'UKB_freq', 'variant_id'],
...
calls = calls[['Chr', 'Start', 'End', 'Type', 'Zygosity', 'Length', 'NumSNP', 'Sample', 'StartSNP', 'EndSNP', 'Merge',
				'Control_num', 'Control_freq', 'UKB_num', 'UKB_freq', 'variant_id', 'Pathogenic_Name']]
