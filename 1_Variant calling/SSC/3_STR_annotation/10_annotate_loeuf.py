...
INPUT='/path/to/input/file.csv' # Use the output of script 9_annotate_gencode_genes.py here
OUTPUT='/path/to/output/table.csv' # Note that the output of this script will be the final coding STR annotations
