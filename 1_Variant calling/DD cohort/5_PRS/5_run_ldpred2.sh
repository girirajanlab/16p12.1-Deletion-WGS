...
INPUT_PLINK=/path/to/input/plink/files # Use the output of script 2_vcf2plink.sh
EUR_SAMPS=/path/to/European/samples.fam # Use the output of script 4_combine_peddy_selfreport.py
