...
INPUT_BED=/path/to/input.bed # Use the file generated from script 5_filter_lowconf_regions.sh
...
python 6.1_str_filter.py $TMP_DIR/str_all_overlap.bed $TMP_DIR
