...
# Get the number of SPARK participants who passed QC
...
dels = pd.read_csv(f'{input_path}/intracohort_anno_dels.bed', sep = '\t',
					names = ['Chr', 'Start', 'End', 'Type', 'Zygosity', 'Length', 'NumSNP', 'Sample', 'StartSNP', 'EndSNP', 'Merge', 'Control_num', 'SPARK_num'])
dels['Control_freq'] = dels.Control_num / ncontrol
dels['SPARK_freq'] = dels.SPARK_num / pass_num
...
dups['SPARK_freq'] = dups.SPARK_num / pass_num
...
patho_del = pd.read_csv(f'{input_path}/pathogenic_anno_dels.bed', sep = '\t',
	names = ['Chr', 'Start', 'End', 'Type', 'Zygosity', 'Length', 'NumSNP', 'Sample', 'StartSNP', 'EndSNP', 'Merge', 'Control_num', 'SPARK_num', 'Patho_chr', 'Patho_Start', 'Patho_End', 'Patho_Name'])
patho_del['Control_freq'] = patho_del.Control_num / ncontrol
patho_del['SPARK_freq'] = patho_del.SPARK_num / pass_num
...
patho_dup['SPARK_freq'] = patho_dup.SPARK_num / pass_num
...
del_calls = dels.merge(patho_del, how = 'outer',
	on = ['Chr', 'Start', 'End', 'Type', 'Zygosity', 'Length', 'NumSNP', 'Sample', 'StartSNP', 'EndSNP', 'Merge', 'Control_num', 'Control_freq', 'SPARK_num', 'SPARK_freq', 'variant_id'],
...
calls = calls[['Chr', 'Start', 'End', 'Type', 'Zygosity', 'Length', 'NumSNP', 'Sample', 'StartSNP', 'EndSNP', 'Merge',
				'Control_num', 'Control_freq', 'SPARK_num', 'SPARK_freq', 'variant_id', 'Pathogenic_Name']]
