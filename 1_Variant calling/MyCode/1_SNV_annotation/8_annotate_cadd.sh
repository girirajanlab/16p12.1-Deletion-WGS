...
INPUT_VCF=/path/to/input.vcf.gz # Use the VCF generated from script 7_filter_pop_frequency.sh here
OUTPUT_FILE=/path/to/output.vcf.gz

# VCFanno needs a TOML file to describe how annotation should be performed
TOML=/path/to/cadd_annotation_file.toml

# Paths to tools
VCFANNO_PATH=/path/to/vcfanno
TABIXPATH=/path/to/tabix

# Annotate CADD scores using VCFanno
