...
input_table='/path/to/input/table.tsv' # Use the output of script 4_filter_pop_frequency.sh
...
df['Func.wgEncodeGencodeBasicV19'] = df['Func.wgEncodeGencodeBasicV19'].str.replace('\\x3b', ';')
df['Gene.wgEncodeGencodeBasicV19'] = df['Gene.wgEncodeGencodeBasicV19'].str.replace('\\x3b', ';')
df['ExonicFunc.wgEncodeGencodeBasicV19'] = df['ExonicFunc.wgEncodeGencodeBasicV19'].str.replace('\\x3b', ';')

# Keep only exonic and splicing
df=df[(df['Func.wgEncodeGencodeBasicV19'].str.contains('exonic')) | (df['Func.wgEncodeGencodeBasicV19'].str.contains('splicing'))]
df=df[(df['Func.wgEncodeGencodeBasicV19']!='ncRNA_exonic') & (df['Func.wgEncodeGencodeBasicV19']!='ncRNA_splicing')]
...
df['Mut_type']='exonic'
df.loc[df['Func.wgEncodeGencodeBasicV19'].str.contains('splicing'), 'Mut_type']='splice'
df.loc[df['ExonicFunc.wgEncodeGencodeBasicV19'].isin(missense_variant_classes), 'Mut_type']='missense'
df.loc[df['ExonicFunc.wgEncodeGencodeBasicV19'].isin(lof_variant_classes), 'Mut_type']='lof'
